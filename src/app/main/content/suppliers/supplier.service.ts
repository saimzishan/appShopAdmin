  ...
  getSupplier(): Promise<any> {
    return new Promise((resolve, reject) => {
        if (this.routeParams.id === 'new') {
            ...
            this.http.get(GLOBAL.USER_API + 'suppliers/' + this.routeParams.id, httpOptions)
...
deleteSuppler(supplier) {
  ...
  return new Promise((resolve, reject) => {
      ...
      this.http.delete(GLOBAL.USER_API + 'suppliers/' + supplier.id, httpOptions)
          .subscribe((response: any) => {
              this.spinnerService.requestInProcess(false);
              if (!response.error) {
                  resolve(response);
...
saveSupplier(supplier) {
  ...
  return new Promise((resolve, reject) => {
      ...
      this.http.put(GLOBAL.USER_API + 'suppliers/' + supplier.id, supplier, httpOptions)
          .subscribe((response: any) => {
              this.spinnerService.requestInProcess(false);
              if (!response.error) {
                  resolve(response);
  ...
  getGermanyJson() {
    return this.http.get('assets/js/germany-state.json') 
  ...
  getCanadaJson() {
    return this.http.get('assets/js/canada-state.json') 
    .map((response: Response) => {
        return response;
    }
    )
