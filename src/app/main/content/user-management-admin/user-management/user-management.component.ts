...
export class UserManagementComponent implements OnInit, OnDestroy {
    ...
    getUserById(id: number) {
        ...
        this.sub = this.userMService.getUserById(id).subscribe((res: any) => {
    ...
    createUser() {
        this.spinnerService.requestInProcess(true);
        this.sub = this.userMService.addUser(this.user).subscribe((res: any) => {
    ...
    deleteUser() {
        this.spinnerService.requestInProcess(true);
        this.sub = this.userMService.deleteUser(this.user.id).subscribe((res: any) => {
            let e = res.res.message;
            this.snotifyService.success(e, 'Success !');
            this.spinnerService.requestInProcess(false);
            this.router.navigate(['/user-management/manage-user/users']);
